...
const baseURL = "http://api.bitflyer.com/v1/"
...
func (t *Ticker) GetMidPrice() float64 {
	return (t.BestBidSize * t.BestAsk) / 2
}
...
func (api *APIClient) GetResultTimeTickter(symbol string, ch chan<- Ticker) {
	...
	if err := c.WriteJSON(&JsonPRC2{Version: "2.0", Method: "subscribe", Params: &SubscribeParams{channel}}); err != nil {
